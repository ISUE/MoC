...
public class SurveyDreamWindow extends GenericPopup {
	//================================================================================================================
	//----------------------------------------------------------------
	...
	public SurveyDreamWindow(SpoutPlayer player, MOCDreamCatcher plugin) {
		this.plugin = plugin;
		this.player = player;
		...
		//Questions
		labelQuestion01 = new GenericLabel("Rate overall dream experience");
		...
		labelQuestion02 = new GenericLabel("Did you learn something new?");
		...
		labelQuestion03 = new GenericLabel("How easy was it to understand the topic presented?");
		...
		labelQuestion04 = new GenericLabel("Were you inspired to create a world of your own?");
		...
		labelQuestion05 = new GenericLabel("Do you feel that the dream creator did a good job?");
	...
	public void onClick(Button button) {
		...
		if (button.equals(buttonSubmit)) {
			String dreamName = "UnknownDream";
			try { dreamName = player.getWorld().getName().split("_")[player.getLocation().getWorld().getName().split("_").length-1]; } catch (ArrayIndexOutOfBoundsException e) {}
			
			String surveyName = dreamName + plugin.getConfiguration().getDateString() + ".txt";
			
			File surveyDir = new File(plugin.getDataFolder().getAbsolutePath() + File.separator + "survey" + File.separator + player.getName() + File.separator + "dreaming");
			surveyDir.mkdirs();
