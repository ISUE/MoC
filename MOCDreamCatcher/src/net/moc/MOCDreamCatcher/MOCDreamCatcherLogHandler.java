...
public class MOCDreamCatcherLogHandler {
	//==============================================================
	private MOCDreamCatcher plugin;
	private Logger logger;
	public MOCDreamCatcherLogHandler(MOCDreamCatcher plugin){
		this.plugin = plugin;
	...
	public void sendPlayerNormal(String playerName, String message) {
		...
		if (player != null) player.sendMessage(this.buildStringPlayer(message, ChatColor.AQUA));
