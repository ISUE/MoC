...
public class ImageImportConfig {
	private YamlConfiguration config;
	private File configFile;
	private ImageImport plugin;
	private String pathSettingMinHeight = "Settings.Height.Minimum";
	private String pathSettingMaxHeight = "Settings.Height.Maximum";
	...
	public ImageImportConfig(ImageImport plugin, File file) {
	...
	public int getMaxHeight() { return this.config.getInt(pathSettingMaxHeight); }
	public void setMaxHeight(int value) { this.config.set(pathSettingMaxHeight, value); }
	
	public int getMinHeight() { return this.config.getInt(pathSettingMinHeight); }
	public void setMinHeight(int value) { this.config.set(pathSettingMinHeight, value); }
	...
	public void reload() {
		if (configFile.exists()) {
			this.load();
			if(this.config.getString(this.pathSettingMinHeight) == null) this.config.set(this.pathSettingMinHeight, 0);
			if(this.config.getString(this.pathSettingMaxHeight) == null) this.config.set(this.pathSettingMaxHeight, 254);
			if(this.config.getString(this.pathColors) == null) this.loadDefaultColors();
			this.save();
			
		} else {
			this.config.set(this.pathSettingMinHeight, 0);
			this.config.set(this.pathSettingMaxHeight, 254);
	...
	private void buildPalette() {
		for (String s : this.list(this.pathColors)) {
			...
			if (Material.getMaterial(typeId) != null) this.plugin.getPalette().addColorBlock(new ImageImportColorBlock(new Color(r, g, b), typeId, data));
