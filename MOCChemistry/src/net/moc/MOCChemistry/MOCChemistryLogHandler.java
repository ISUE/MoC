...
public class MOCChemistryLogHandler {

	//==============================================================
	private MOCChemistry plugin;
	private Logger logger;
	public MOCChemistryLogHandler(MOCChemistry plugin){
		this.plugin = plugin;
	...
	public void sendPlayerNormal(Player player, String message) { player.sendMessage(this.buildStringPlayer(message, ChatColor.GREEN)); }
