package xmisc.GlowWorld.GlowWorld.src.com.GlowWorld.ChunkGenerator;
...
public class ChunkGenerator extends org.bukkit.generator.ChunkGenerator {
	...
	public List<BlockPopulator> getDefaultPopulators(World world) {
    	...
    	pop.add(new xmisc.GlowWorld.GlowWorld.src.com.GlowWorld.BlockPopulators.ChestPopulator());
    	return pop;
