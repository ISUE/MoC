...
public class ChangeSignLogHandler {

	//==============================================================
	private ChangeSign plugin;
	private Logger logger;
	public ChangeSignLogHandler(ChangeSign plugin){
		this.plugin = plugin;
	...
	public void sendPlayerWarn(Player player, String message) {
		if (player != null) player.sendMessage(this.buildStringPlayer(message, ChatColor.RED));
	}
